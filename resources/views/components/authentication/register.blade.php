...
<head>
    <title>Dapur Lezat &mdash; Register</title>
    <meta charset="utf-8" />
    <meta name="description"
        content="
            Dapur Lezat adalah sebuah platform aplikasi yang membantu Anda dalam mengatur menu makanan Anda.
        " />
    <meta name="keywords"
        content="
            Dapur Lezat, aplikasi menu makanan, perencanaan makanan, resep masakan, manajemen dapur, gizi seimbang, meal prep
        " />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="
            Dapur Lezat &mdash; Register
        " />
            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    ...
                    <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="/assets/media/auth/logo.webp" alt="" />
                ...
                <div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
                    ...
                    <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                            ...
                            <!--begin::Form-->
                            <form class="form h-400px overflow-y-scroll w-100" novalidate="novalidate" id="kt_sign_up_form"
                                ...
                                <div class="text-center mb-11">
                                    ...
                                    <div class="text-gray-500 fw-semibold fs-6">
                                        Silahkan masukkan data diri Anda untuk membuat akun Dapur Lezat
                                    </div>
                                    <!--end::Subtitle--->
                                </div>
                                <!--begin::Heading-->
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::Email-->
                                    <input type="text" placeholder="Nomor HP" name="no_hp" autocomplete="off"
                                        class="form-control bg-transparent" />
                                    <!--end::Email-->
                                </div>
                                <!--end::Input group--->
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::Email-->
                                    <input type="text" placeholder="Kota" name="kota" autocomplete="off"
                                        class="form-control bg-transparent" />
                                    <!--end::Email-->
                                </div>
                                <!--end::Input group--->
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::Email-->
                                    <input type="text" placeholder="Provinsi" name="provinsi" autocomplete="off"
                                        class="form-control bg-transparent" />
                                    <!--end::Email-->
                                </div>
                                <!--end::Input group--->
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::Role-->
                                    <select class="form-select" name="role" data-control="select2" data-placeholder="Pilih Role">
                                        <option></option>
                                ...
                                <div class="fv-row mb-8">
                                    ...
                                    <input placeholder="Konfirmasi Kata Sandi" name="confirm-password"
                                ...
                                <div class="fv-row mb-8">
                                    <label class="form-check form-check-inline">
                                        ...
                                        <span class="form-check-label fw-semibold text-gray-700 fs-base ms-1">
                                            ...
                                            Saya menerima <a href="#" class="ms-1 link-primary pointer-events-none">Syarat & Ketentuan</a>
                                        </span>
                                    </label>
                                </div>
                                <!--end::Accept-->
