<div id="kt_header" class="header ">
    ...
    <div class=" container-fluid  d-flex align-items-center flex-wrap justify-content-between" id="kt_header_container">
        ...
        <div class="d-flex d-lg-none align-items-center ms-n4 me-2">
            ...
            <!--begin::Logo-->
            <span class="fw-bold text-center fs-2x">Dapur Lezat</span>
            <!--end::Logo-->
        </div>
        <!--end::Wrapper-->
        ...
        <div class="d-flex align-items-center flex-shrink-0">
            ...
            <!--begin::Search-->
            {{-- <div id="kt_header_search" class="pointer-events-none header-search d-flex align-items-center w-lg-250px"
