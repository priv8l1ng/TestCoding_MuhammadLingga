...
<head>
    <title>Dapur Lezat &mdash; {{ $title ?? 'Home' }}</title>
    <meta charset="utf-8" />
    ...
    <link rel="shortcut icon" href="/assets/media/auth/logo.webp" />
...
<body id="kt_body">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            <!--begin::Aside-->
            @include('components.dashboard.layouts.left-sidebar')
            <!--end::Aside-->
            <!--begin::Wrapper-->
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                <!--begin::Header-->
                @include('components.dashboard.layouts.header')
                <!--end::Header-->
                <!--begin::Content-->
                @yield('content')
                <!--end::Content-->
    ...
    @include('components.dashboard.layouts.activities-drawer')
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <input class="form-control d-flex align-items-center" value=""
                                            ...
                                            data-kt-flags-path="/metronic8/demo15/assets/media/flags/" />
                                        <!--end::Tagify-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-8">
                                            ...
                                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                ...
                                                <span class="ms-1" data-bs-toggle="popover"
